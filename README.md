...
<p align="center">
  <em>Tek/Çift backend modu (Claude · Codex · Gemini) · ed25519 imzalı iPhone pairing · Plan Mode read-only allowlist · macOS Dock mascot · MCP server expose (14 tool, 5 `ui_*` AX-first + chained query DSL + opaqueID resolve + ⌘/⌥/⇧/⌃-click + IME-aware text) · Subagent UI paneli (paralel cap=3) · LAN-first Bonjour transport (iOS) · 362 test yeşil · 29 ADR</em>
</p>
...
**Versiyon:** `v0.2.14` (23 May 2026) · **362 test** yeşil · **29 ADR** · 10 library + 2 executable target · **end-to-end iPhone test'i** doğrulandı
