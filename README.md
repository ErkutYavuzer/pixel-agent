...
<p align="center">
  <em>Native Swift · Multi-LLM · iOS remote dashboard · MCP server (14 tools) · Subagent UI · Computer use with Set-of-Mark · 574 tests · 32 ADRs</em>
</p>
...
**v0.2.27** (2026-05-24) · **574 tests** passing · **32 ADRs** · 10 libraries + 2 executables · Sprint 2 power-user touches shipped.
